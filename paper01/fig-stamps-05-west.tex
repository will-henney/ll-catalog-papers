\begin{figure*}
  ...
  \begin{tabular}{l l l }
    ...
    \BowshockFig{w030-524-Bally_01-images} & \BowshockFig{042-628-Bally_16-images} & \BowshockFig{w044-527-Bally_01-images} \\
    \raiselabel{(\textit{s})} & \raiselabel{(\textit{t})} & \raiselabel{(\textit{u})} \\
    \BowshockFig{LL1-Bally_01-images} & \BowshockFig{w069-601-Bally_01-images} \\
    \raiselabel{(\textit{v})} & \raiselabel{(\textit{w})} \\
  \end{tabular}
